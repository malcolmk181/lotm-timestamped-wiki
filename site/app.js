...
function renderAbout(sidebar, content) {
  ...
  box.innerHTML = [
    ...
    "<p class=\"about-note\">Built with <a href=\"https://hermes-agent.nousresearch.com/docs\" target=\"_blank\" rel=\"noopener\">Hermes Agent</a> (Nous Research) and <a href=\"https://qwenlm.github.io/\" target=\"_blank\" rel=\"noopener\">Qwen</a> / <a href=\"https://www.deepseek.com\" target=\"_blank\" rel=\"noopener\">DeepSeek</a> language models via OpenRouter. An independent, non-profit fan reference \u2014 not affiliated with the author, publisher, or LOTM-Reader.</p>",
  ].join("");
  content.appendChild(box);
}
